...
namespace WireframePlexus {
    [UpdateAfter(typeof(VertexMoveSystemOld))]
    public partial struct EdgeMoveSystemOld : ISystem {
        ...
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (Entity plexusObject in plexusObjectEntries) {
                ...
                PlexusEdgeMovementJobOld job = new PlexusEdgeMovementJobOld {
        ...
        [BurstCompile]
        public partial struct PlexusEdgeMovementJobOld : IJobEntity {
